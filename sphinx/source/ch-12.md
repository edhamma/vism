...
[^15]:
    ...
    The only book in the Tipiṭaka to mention the Twin Miracle is the Paṭisambhidāmagga ({term}`Paṭis` *I 53*).16 Anāthapiṇḍika’s younger brother ({term}`Vism-mhṭ` *391*).
