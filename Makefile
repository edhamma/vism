...
assemble:
	...
	cp -r html5 build/
	cp -r docbook build/
	rsync -a sphinx/ build/sphinx-rst
	rsync -a sphinx/ build/sphinx
	rsync -a sphinx-vimm/ build/sphinx-rst-vimm
	rsync -a sphinx-vimm/ build/sphinx-vimm
...
sphinx: build/vism.sectioned.tei sphinx/source/*
	...
	make -C build/sphinx-rst html singlehtml epub
...
vimuttimagga: build/vimm.tei
	...
	make -C build/sphinx-rst-vimm html singlehtml epub
